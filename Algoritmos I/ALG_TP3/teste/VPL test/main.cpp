...
// PROGRAMAÇÃO DINÂMICA
        ...
        // constrói um vetor de árvores de possibilidades, uma iniciando em cada cidade
        vector<vector<vector<int>>> possibility_trees = buildPossibilityTrees(n_cities, g);
        // navega pelo vetor e seleciona o caminho de menor custo dentre os possíveis
        vector<int> smallest_path = returnSmallestPath(possibility_trees);
        // imprime o resultado
        printResult(smallest_path, g);
    }
